...
namespace SpeditoReposity.Migrations
{
    ...
    [Migration("20210520195614_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpeditoReposity.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpeditoReposity.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpeditoReposity.Models.FoodCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpeditoReposity.Models.Category", b =>
                {
                    b.HasOne("SpeditoReposity.Models.Department", "Department")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("SpeditoReposity.Models.Product", b =>
                {
                    b.HasOne("SpeditoReposity.Models.Category", "Category")
                        .WithMany()
